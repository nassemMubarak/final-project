...
<script>
// import {transNEWS} from '@localStorage'
...
export default {
    ...
    data() {
        return {
            ...
            detailsNews: JSON.parse(transNEWS.detailsNews),
        }
    },
    mounted() {
    ...
    methods:{
        getNews(){
            if(transNEWS.detailsNews){
                return JSON.parse(transNEWS.detailsNews);
            }else{
                return  JSON.parse(localStorage.getItem("detailsNews"));
            }
        }
    }
}
