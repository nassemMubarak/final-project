<template>
    <div id="politics-page">

        <div class="page-title wb">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <h2><i class="fa fa-shopping-bag bg-red"></i> Politics<small
                            ...
                            <div class="blog-list clearfix">
                                <div class="blog-box row">
                                    <div class="col-md-4">
                                        <div class="post-media">
                                            <a href="single.html" title="">
                                                <img src="../../public\frontend\assets\upload/blog_square_05.jpg" alt=""
                                                    class="img-fluid">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        ...
                                        <small><a href="blog-category-01.html" title="">Politics</a></small>
                                ...
                                <div class="blog-box row">
                                    <div class="col-md-4">
                                        <div class="post-media">
                                            <a href="single.html" title="">
                                                <img src="../../public\frontend\assets\upload/blog_square_06.jpg" alt=""
                                                    class="img-fluid">
                                                <div class="hovereffect"></div>
                                            </a>
                                        </div><!-- end media -->
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <h4><a href="single.html" title="">10 practical ways to choose organic
                                                vegetables</a></h4>
                                        <p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et
                                            pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus enim nibh,
                                            maximus ac felis nec, maximus tempor odio.</p>
                                ...
                                <div class="blog-box row">
                                    <div class="col-md-4">
                                        <div class="post-media">
                                            <a href="single.html" title="">
                                                <img src="../../public\frontend\assets\upload/blog_square_07.jpg" alt=""
                                                    class="img-fluid">
                                                <div class="hovereffect"></div>
                                            </a>
                                        </div><!-- end media -->
                                ...
                                <div class="blog-box row">
                                    <div class="col-md-4">
                                        <div class="post-media">
                                            <a href="single.html" title="">
                                                <img src="../../public\frontend\assets\upload/blog_square_08.jpg" alt=""
                                                    class="img-fluid">
                                                <div class="hovereffect"></div>
                                            </a>
                                        </div><!-- end media -->
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <h4><a href="single.html" title="">What do you think of a luxurious and elegant
                                                restaurant?</a></h4>
                                        <p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et
                                            pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus enim nibh,
                                            maximus ac felis nec, maximus tempor odio.</p>
                                ...
                                <div class="blog-box row">
                                    <div class="col-md-4">
                                        <div class="post-media">
                                            <a href="single.html" title="">
                                                <img src="../../public\frontend\assets\upload/blog_square_09.jpg" alt=""
                                                    class="img-fluid">
                                                <div class="hovereffect"></div>
                                            </a>
                                        </div><!-- end media -->
                                ...
                                <div class="blog-box row">
                                    <div class="col-md-4">
                                        <div class="post-media">
                                            <a href="single.html" title="">
                                                <img src="../../public\frontend\assets\upload/blog_square_10.jpg" alt=""
                                                    class="img-fluid">
                                                <div class="hovereffect"></div>
                                            </a>
                                        </div><!-- end media -->
                                ...
                                <div class="blog-box row">
                                    <div class="col-md-4">
                                        <div class="post-media">
                                            <a href="single.html" title="">
                                                <img src="../../public\frontend\assets\upload/blog_square_11.jpg" alt=""
                                                    class="img-fluid">
                                                <div class="hovereffect"></div>
                                            </a>
                                        </div><!-- end media -->
                                ...
                                <div class="blog-box row">
                                    <div class="col-md-4">
                                        <div class="post-media">
                                            <a href="single.html" title="">
                                                <img src="../../public\frontend\assets\upload/blog_square_12.jpg" alt=""
                                                    class="img-fluid">
                                                <div class="hovereffect"></div>
                                            </a>
                                        </div><!-- end media -->
                        ...
                        <div class="sidebar">
                            ...
                            <div class="widget">
                                ...
                                <div class="instagram-wrapper clearfix">
                                    <a class="" href="#"><img src="../../public\frontend\assets\upload/insta_01.jpeg" alt=""
                                            class="img-fluid"></a>
                                    <a href="#"><img src="../../public\frontend\assets\upload/insta_02.jpeg" alt=""
                                            class="img-fluid"></a>
                                    <a href="#"><img src="../../public\frontend\assets\upload/insta_03.jpeg" alt=""
                                            class="img-fluid"></a>
                                    <a href="#"><img src="../../public\frontend\assets\upload/insta_04.jpeg" alt=""
                                            class="img-fluid"></a>
                                    <a href="#"><img src="../../public\frontend\assets\upload/insta_05.jpeg" alt=""
                                            class="img-fluid"></a>
                                    <a href="#"><img src="../../public\frontend\assets\upload/insta_06.jpeg" alt=""
                                            class="img-fluid"></a>
                                    <a href="#"><img src="../../public\frontend\assets\upload/insta_07.jpeg" alt=""
                                            class="img-fluid"></a>
                                    <a href="#"><img src="../../public\frontend\assets\upload/insta_08.jpeg" alt=""
                                            class="img-fluid"></a>
                                    <a href="#"><img src="../../public\frontend\assets\upload/insta_09.jpeg" alt=""
                                            class="img-fluid"></a>
                            ...
                            <div class="widget">
                                ...
                                <div class="link-widget">
                                    <ul>
                                        ...
                                        <li><a href="#">Politics & Drink <span>(87)</span></a></li>
                                    </ul>
                                </div><!-- end link-widget -->
                            </div><!-- end widget -->
                        </div><!-- end sidebar -->
