            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <h2><i class="fa fa-shopping-bag bg-pink"></i> Politics <small class="hidden-xs-down hidden-sm-down">Nulla felis eros, varius sit amet volutpat non. </small></h2>
                    </div><!-- end col -->
                            ...
                            <div class="portfolio row">
                                <div class="pitem item-w1 item-h1">
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta">
                                            <span class="bg-pink"><a href="blog-category-01.html" title="">Politics</a></span>
                                ...
                                <div class="pitem item-w1 item-h1">
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <a href="single.html" title="">
                                                <img src="../../public\frontend\assets\upload/author_02.jpg" alt="" class="img-fluid">
                                                <div class="hovereffect">
                                                    <span></span>
                                                </div><!-- end hover -->
                                            </a>
                                ...
                                <div class="pitem item-w1 item-h1">
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta">
                                            <span class="bg-pink"><a href="blog-category-01.html" title="">Politics</a></span>
                                            <h4><a href="single.html" title="">We have been talking about one of the pioneers of male Politics</a></h4>
                                            <small><a href="blog-author.html" title="">By: Jessica</a></small>
                                ...
                                <div class="pitem item-w1 item-h1">
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <a href="single.html" title="">
                                                <img src="../../public\frontend\assets\upload/author.jpg" alt="" class="img-fluid">
                                                <div class="hovereffect">
                                                    <span></span>
                                                </div><!-- end hover -->
                                            </a>
                                ...
                                <div class="pitem item-w1 item-h1">
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <a href="single.html" title="">
                                                <img src="../../public\frontend\assets\upload/author_01.jpg" alt="" class="img-fluid">
                                                <div class="hovereffect">
                                                    <span></span>
                                                </div><!-- end hover -->
                                            </a>
                                ...
                                <div class="pitem item-w1 item-h1">
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <a href="single.html" title="">
                                                <img src="../../public\frontend\assets\upload/author_03.jpg" alt="" class="img-fluid">
                                                <div class="hovereffect">
                                                    <span></span>
                                                </div><!-- end hover -->
                                            </a>
