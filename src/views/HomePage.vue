            ...
            <div class="container-fluid">
                <div class="masonry-blog clearfix">
                    ...
                    <div class="center-side">
                        <div class="masonry-box post-media">
                            <img :src="news.politics[0].image" alt="" class="img-fluid"/>
                            <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                    ...
                    <div class="right-side hidden-md-down">
                        <div class="masonry-box post-media">
                            <img :src="news.sport[1].image" alt="" class="img-fluid"/>
                            <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="section-title">
                            <h3 class="color-pink">
                                <router-link to="/politics"><a href="" title="">{{ news.politics[0].type }}</a>
                                </router-link>
                        ...
                        <div class="blog-list clearfix">
                            <div class="section-title">
                                <h3 class="color-green">
                                    <router-link to="/Economic" ><a href="" title="">{{ news.economic[2].type }}</a>
                                    </router-link>
...
import {baseUrl} from '@/reactive/transfer_news'
...
`
                ...
                politics: [
                    ...
                    },
                    {
                        ...
                        by: 'قناة الأقصى',
                        image: 'https://seraj.tv/thumb.php?src=uploads//images/1d453f4357afeb0f95be26418ec5a8e7.jpg&w=780&h=450',
                    },
                    {
                        title: 'المصادقة بالقراءة الأولى على عودة الاستيطان لشمال الضفة',
                        type: 'السياسة',
